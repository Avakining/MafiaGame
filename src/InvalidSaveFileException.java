...
public class InvalidSaveFileException extends IOException{
	...
	/**
	 * Constructs an {@code InvalidSaveFileException} with {@code null} as its error detail message.
	 */
	...
	/**
	 * Constructs an {@code InvalidSaveFileException} with the specified cause and a detail message of {@code (cause==null ? null : cause.toString())} (which typically contains the class and detail message of {@code cause}). This constructor is useful for IO exceptions that are little more than wrappers for other throwables.
	 *
	...
	/**
	 * Constructs an {@code InvalidSaveFileException} with the specified detail message
	 * and cause.
	 *
	 * <p>
